...
| `/v2/` | **v2** — мультимодельный просмотрщик: выпадающий список моделей, режимы Текстура / Геометрия / Wireframe, **загрузка новых сканов прямо с сайта** (.glb / .stl). three.js с CDN | `v2/index.html`, `v2/*.glb`, `v2/uploads/` (runtime) |
