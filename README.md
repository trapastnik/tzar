...
| `/splats/` | **Gaussian Splats** — фотореалистичные 3D-сцены (.ply / .splat / .ksplat, движок @mkkellogg/gaussian-splats-3d): список сцен, повороты с сохранением, загрузка на сайт и локальный просмотр drag&drop. Общие с v2 API/models.json | `splats/index.html` |
